...
public:
	...
	JacobianPseudoInverse(int maxTries = 50, double targetThreshold = 0.05, double stepweight= 0.5, double dampling = 0.1): IKSolver(maxTries, targetThreshold, stepweight),
		m_dampling(dampling){}
