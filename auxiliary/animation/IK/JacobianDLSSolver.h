...
namespace Etoile
{
	...
	class JacobianDLSSolver : public IKSolver
	{
		double m_dampling;
	public:
		JacobianDLSSolver(int maxTries = 100, double targetThreshold = 0.005, double stepweight= 0.5, double dampling = 0.9):IKSolver(maxTries, targetThreshold, stepweight),
		m_dampling(dampling){}
